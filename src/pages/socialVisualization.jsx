       ...
       //  let newOpennessOutputData={};
        ...
        for(let i=0;i<Object.keys(res.data[0]).length;i++){
         ...
         if(res.data[i].openness){
           ...
           newOpennessData={y:percentagesData[0],name:'openness',category:SubOpenness,data:OpennessData,color:'#FF9843'}
           // newOpennessData={y:res.data[0].openness,name:'openness',category:SubOpenness,data:[]}
         ...
         if(res.data[i].conscientiousness){
           ...
           newConscientiousnessOutputData={y:percentagesData[1],name:'conscientiousness',category:SubConscientiousness,data:ConscientiousnessData,color:'#D24545'}
         ...
         if(res.data[i].extraversion){
           ...
           newExtraversionOutputData={y:percentagesData[2],name:'extraversion',category:SubExtraversion,data:ExtraversionData,color:'#86A7FC'}
         ...
         if(res.data[i].agreeableness){
           ...
           newAgreeablenessOutputData={y:percentagesData[3],name:'agreeableness',category:SubAgreeableness,data:AgreeablenessData,color:'#597E52'};
         ...
         if(res.data[i].neuroticism){
           ...
           newNeuroticismOutputData={y:percentagesData[4],name:'neuroticism',category:SubNeuroticism,data:NeuroticismData,color:'#FF8F8F'};
           Data.push(newNeuroticismOutputData);
         }
